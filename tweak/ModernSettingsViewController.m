...
#import "EMPremium/EMPremiumSettingsViewController.h"
...
- (void)setupSections {
    self.sections = @[
        @{ @"title": [[BHTBundle sharedBundle] localizedStringForKey:@"EM_PREMIUM_SETTINGS_TITLE"],
           @"subtitle": [[BHTBundle sharedBundle] localizedStringForKey:@"EM_PREMIUM_SETTINGS_SUBTITLE"],
           @"icon": @"verified_stroke", @"action": @"showPremiumSettings" },
...
- (void)showPremiumSettings {
    EMPremiumSettingsViewController *vc = [[EMPremiumSettingsViewController alloc] initWithAccount:self.account];
